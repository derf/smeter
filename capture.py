...
class top_block(gr.top_block):
    def __init__(self):
        ...
        self.freq_xlating_fir_filter_xxx_0_1 = filter.freq_xlating_fir_filter_ccc(
            ...
            (
                firdes.low_pass(
                    ...
                    cutoff,
                    width,
                    fft_python.window.win_type.WIN_BLACKMAN,
                    6.76,
                )
            ),
            -freq_offset,
        ...
        self.connect(
            (self.osmosdr_source_c_0_1, 0), (self.freq_xlating_fir_filter_xxx_0_1, 0)
        )
        self.connect(
            (self.analog_simple_squelch_cc_0, 0), (self.analog_quadrature_demod_cf_0, 0)
        )
    ...
    def set_width(self, width):
        self.width = width
        self.freq_xlating_fir_filter_xxx_0_1.set_taps(
            (
                firdes.low_pass(
                    1,
                    self.samp_rate,
